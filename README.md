...
Simply click [here](https://github.com/Verpous/AlwaysShadow/releases/download/v1.2/AlwaysShadow.exe), or you can go to [Releases](https://github.com/Verpous/AlwaysShadow/releases) and choose what to download. And of course, you can always clone the repo and compile it yourself.
