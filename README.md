...
## Download
You can download the compiled program [here](https://github.com/Verpous/AlwaysShadow/releases/download/v1.0/AlwaysShadow.zip), or you can go to [Releases](https://github.com/Verpous/AlwaysShadow/releases) and choose what to download. If you experience errors, try downloading the "static linking" version from there. And of course, you can always clone the repo and compile it yourself.
